    ...
    <nav className="bg-gold p-3 shadow-lg">
      <div className="max-w-screen-xl mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          ...
          transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_15px_rgba(255,215,0,0.7)]">Login</a>
          <a href="/join" className="text-white font-bold px-4 py-2 rounded bg-black shadow-xl
