  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <section className="my-12 flex flex-col items-center text-center">
        ...
        <button className="mt-6 px-6 py-3 bg-metal-gold text-black font-bold text-lg rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400">
          Join Now
        </button>
      </section>
